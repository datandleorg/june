            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Inventory Inward Log Report</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Inventory Inward Log Report</li>
                        </ol>
                                        ...
                                        <tbody>
                                            <?php
                                               ...
                                               // $sql = "SELECT * from purchaseitemlog where 1=1";
                                                $sql = "SELECT orgid,itemcode,itemname,qtyadjusted,qtyonhand,concat(qtyonhand-qtyadjusted)as oldqty ,uom,adjustedon,handler,notes,id FROM purchaseitemlog where";   
                                                ...
                                                if($_GET['st']!=''){
                                                    ...
                                                    $sql = "SELECT orgid,itemcode,itemname,qtyadjusted,qtyonhand,concat(qtyonhand-qtyadjusted)as oldqty ,uom,adjustedon,handler,notes,id FROM purchaseitemlog ORDER BY id DESC ;";   
                                                }
                                                //echo $sql; 
