...
{ 
    ...
    $sql = "UPDATE `purchaseitemaster` 
			SET ";
    $sql.= $entrytype == "outsourced" ? " `custid` = '".$orgid."' " : " `orgid` = '".$orgid."' ";
	$sql.= ", `itemname` = '".$itemname."',
				...
				`handler`='".$handler."'				
			WHERE `itemcode` ='".$purchaseItmMasterID."'";										
	...
	$sql1="INSERT into purchaseitemlog(`orgid`,`itemcode`,
										`itemname`,
										`qtyonhand`,
										`qtyadjusted`,
										`uom`,
							...
							<div class="card-body">
									...
									<?php
											...
											if(isset($_GET['itemcode']))
											{
												...
												$result = mysqli_query($dbcon, "SELECT * FROM purchaseitemaster
									...
									<div class="form-row">												
										...
										<input type="text" class="form-control form-control-sm" name="entrytype"  readonly value="<?php echo $entrytype;?>" />
										</div>
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
									  ...
									  <input type="text" class="form-control form-control-sm" name="itemname" readonly value="<?php echo $itemname;?>" />
									  </div>
									  </div>
								 ...
								 <div class="form-row">
									...
									<div class="form-row">
								     <div class="modal-footer">
										<input type="hidden" name="purchaseItmMasterID" value="<?=$_GET['itemcode']?>">
