...
if(isset($_SESSION['login_email'])){
    ...
    $sq = "select username,compcode from userprofile where id='$userid'";
...
<td class="text-right"><i class="fa fa-wrench bigfonts" aria-hidden="true"></i><strong>&nbsp;Tools</strong>
                                        ...
                                        <td class="text-center"><a  href="listCustomerPayments.php">
                                                            &nbsp;Customer Payments Made</i></a></td>														
                ...
                <li class="list-inline-item dropdown notif">						
                    <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" 
                       role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <small> <span><b><font face="Hemi Head Rg" color="orange">
...
<a href="charts.html"><i class="fa fa-fw fa-area-chart"></i><span> Charts </span> </a>
                    ...
                    <li class="submenu">
                        ...
                        <ul class="list-unstyled">	
                            ...
                            <li><a href="listItemaster.php"><i class="fa fa-plus-circle"></i>Rawmaterials</a></li>
                            <li><a href="addProdItemaster.php"><i class="fa fa-plus-circle"></i>Production Items</a></li>
