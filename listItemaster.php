                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover display">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "select orgid,proditemcode,itemcode,itemname,inputqty,uom,createdby,id from rawitemaster order by id asc";
												...
												echo '<td>' .$row['proditemcode'].'</td>';
													echo '<td>' .$row['itemcode'].'</td>';
													echo '<td>' .$row['itemname'].'</td>';
													echo '<td>' .$row['inputqty'].'</td>';
													echo '<td>' .$row['uom'].'</td>';
                                            ...
                                            function delete_record(x)
                                            {
                                               ...
                                               alert(row_id);
                                                if (confirm('Confirm delete')) {
                                                  window.location.href = 'deleteItemaster.php?id='+row_id;
                                               }
                                            }
											 </script>   
											 </tbody>
