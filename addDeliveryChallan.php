            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Delivery Challan</h1>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h5><div class="text-muted font-light"><i class="fa fa-truck smallfonts" aria-hidden="true"></i>&nbsp;Delivery Challan<span class="text-muted"></span></div></h5>

                            <div class="text-muted font-light">New Delivery Challan</div>
...
<td><input type="text" name="itemcode" placeholder="Item Details" class="form-control"></td>-->
                                ...
                                <br>
								   ...
								   <div class="form-row col-md-12">
                                    <div class="form-group col-md-8">
                                        <textarea rows="2" class="form-control" name="so_termscond"  id="so_termscond" required placeholder="add Sales Order Terms & Conditions to reflect in Invoice"></textarea>
                                    
									<div class="col-md-12 col-md-offset-12">
                                                <input type="checkbox" id="paymentemail" name="paymentemail" value="payment_email">
                                                <label for="subscribeNews">Check once to repeat all other sales orders</label>									
                                            </div>
                                </div>

                                <div class="form-row col-md-12">
                                    <div class="form-group col-md-8">
                                        <textarea rows="2" class="form-control" name="po_notes"  id="po_notes" required placeholder="add a Sales order notes to reflect in sales order"></textarea>
                                    </div>
                                </div>
