							...
							<div class="card-body">
								...
								<?php
                                        ...
                                        if(isset($_GET['id']))
                                        {
                                            ...
                                            $result = mysqli_query($dbcon, "SELECT orgid,title,orgname,shortname,orgtype,blocation,
									...
									<div class="form-group col-md-11">
									  ...
									  <input type="text" class="form-control form-control-sm" name="shortname" value="<?php echo $shortname;?>" />
									</div>
									</div>
