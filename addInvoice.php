                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form id="add_inv_form" autocomplete="off" action="#">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        name="inv_customer" required>
                                            ...
                                            while ($row = $sql->fetch_assoc()){	
                                                ...
                                                $custype=$row['custype'];
                                                echo '<option data-type="'.$custype.'"  value="'.$custid.'" >'.$custid.' '.$custname.'</option>';
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-row">	
                                    <div class="form-group col-md-4">
                                        <input type="text" placeholder="Truck no."  name="inv_truck_no" id="inv_truck_no"  class="form-control form-control-sm" > 
                                    </div>

                                    <div class="form-group col-md-4">
                                        <input type="text" placeholder="Driver Name" name="inv_driver_name" id="inv_driver_name"  class="form-control form-control-sm"  > 
                                    </div>
                                </div>
...
<td><input type="text" name="itemcode" placeholder="Item Details" class="form-control"></td>-->
    ...
    <script>       
        ...
        function onCustSelect(custid){
            var custype = $('#inv_customer option:selected').attr('data-type');
