                ...
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        ...
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item active">Expenses Reprot</li>
                        </ol>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <h3><i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i><b>&nbsp;Expenses Reports </b></h3>
                        </div>
                                    ...
                                    <table id="po_reports" class="table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0){
                                                ...
                                                <td>'.$row['expense_payee_type'].'</td>
                                                <td>'.$row['expense_paid_thru'].'</td>
                                                <td>'.$row['expense_invoice_no'].'</td>
                                                <td>'.$row['expense_total_amount'].'</td>
                                                <td>'.$row['expense_handler'].'</td>
