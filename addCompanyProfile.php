...
if(isset($_POST['submit']))
{
    ...
    $check_orgname_query="select orgname from comprofile WHERE orgname='$orgname'";
    $run_query=mysqli_query($dbcon,$check_orgname_query);
	if(mysqli_num_rows($run_query)>0)
    {
       ...
       // echo "<script>alert('Item Name: $itemname is already exist in our database, Please try another one!')</script>";
        ...
        $orgnameFound = "Company Name: '$orgname'' is already exist in our database, Please try another one!";
       //exit();
        // header("location:addPurchaseItemMaster.php");
    }
    else{	
    
    $insert_comprofile="INSERT INTO comprofile(orgid,title,orgname,shortname,orgtype,blocation,industry,address,city,state,country,zip,workphone,mobile,email,web,gstin,gstregdate,panno,openbalance,balasofdate,primaryflag,image) 
	VALUES('$orgid','$title','$orgname','$shortname','$orgtype','$blocation','$industry','$address','$city','$state','$country','$zip','$workphone','$mobile','$email','$web','$gstin','$gstregdate','$panno','$openbalance','$balasofdate','$primaryflag','$target_file')";
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">						
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <p class="text-danger"><?php echo $orgnameFound;?></p> 
...
style="display: none; width: 0px; height: 0px;"></button-->
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="orgname" placeholder="Full Name of the Company" required class="form-control" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-11">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="shortname" required placeholder="Enter Shortname">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                    ...
                                    <h4 class="col-md-12 text-muted text-info">Company Address &nbsp;</h4>
                                </div>
                            ...
                            <div class="form-row">
                                    ...
                                    <h4 class="col-md-12 text-muted text-info">Tax Details</h4>
