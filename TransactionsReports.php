                                        ...
                                        <tbody>
                                            ...
                                            if((isset($_GET['st'])&&$_GET['st']!='')||(isset($_GET['end'])&&$_GET['end']!='') ||(isset($_GET['payment_mode']))){ 
                                               ...
                                               $sql = "SELECT t.*,DATE_FORMAT(t.trans_date,'%d-%m-%Y') as trans_date,c.bankname,c.acctno from transactions t ,compbank c where c.id=t.trans_bank ";
                                                ...
                                                $sql = "SELECT t.*,DATE_FORMAT(t.trans_date,'%d-%m-%Y') as trans_date,(select bankname from compbank where t.trans_bank!='' and id=t.trans_bank ) as bankname from transactions t  order by t.id desc ;";    
                                            }
