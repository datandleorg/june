...
if(isset($_GET['rw_code']))
{
    ...
    if($rw_entrytype=="self"){
        $sql2 = "SELECT * from comprofile where orgid ='001' limit 1 ";
    }else if($rw_entrytype=="outsourced"){
        $sql2 = "SELECT comp.*, comp.custname as orgname from customerprofile comp where custid ='$rw_custid' limit 1 ";
    }
