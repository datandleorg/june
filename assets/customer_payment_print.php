...
if($cust_type == "auto"){
    $sql = "SELECT i.*,c.*,cr.* from  invoices i , customer_payments c , customerprofile cr where c.cust_payment_id='$cust_payment_id' and i.inv_code=c.cust_payment_invoice_no and i.inv_customer=cr.custid  ;";
...
<html>
    <head>
        ...
        <title>Customer payment print</title>
        <style type="text/css">
            .p_table{
                border:1px soid #000;
            }
